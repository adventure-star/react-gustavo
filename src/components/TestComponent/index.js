...
import { apiGetRecentLessons } from '../../services/news';
...
const TestComponent = (props) => {
    ...
    return (
        <div className="w-full rounded-lg shadow-lg pt-3 mb-8">
            <p className="pl-10 py-4 bg-customPrimary text-white flex items-center rounded-t-lg text-2xl font-custom-bold">Preview Test</p>
